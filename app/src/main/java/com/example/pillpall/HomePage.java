...
import com.dataflair.reminderapp.Model;
...
public class HomePage extends AppCompatActivity {
    ...
    ArrayList<Model> dataholder = new ArrayList<com.dataflair.reminderapp.Model>();                                               //Array list to add reminders and display in recyclerview
    myAdapter adapter;
